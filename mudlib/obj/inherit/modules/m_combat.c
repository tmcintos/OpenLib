...
nomask void
set_weapon_info(mixed *new_weapon_info)
{
...
nomask varargs int
do_unwield(object weapon, int make_noise)
{
  int i, j, hands_info;
...
nomask varargs int
do_wield(object weapon, int hands_used, int make_noise)
{
  mixed *weapon_info, *this_weapon_info;
...
nomask varargs int
do_wear(object armour, int make_noise)
{
...
nomask void
do_remove(object armour, int make_noise)
{
  int i,*j,*k,m;
